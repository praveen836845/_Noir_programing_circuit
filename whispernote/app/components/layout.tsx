    ...
    <>
      ...
      <div className="page">
        <div className="mobile-header">
          ...
          >
            <Link href="/">WhisperWall</Link>
          </div>
        </div>
        <aside className={`sidebar ${isSidebarOpen ? "open" : ""}`}>
          <div className="logo">
            <Link href="/">
              <span style={{fontSize: '1.5rem', fontWeight: 'bold', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>WhisperWall</span>
            </Link>
          </div>
